...
const UI_TRANSLATIONS = {
  ...
  en: {
    ...
    priceOverlayEnabled: "Price overlay: {count} daily points.",
    loaded: "Updated {stamp} · {count} companies · {forecastCount} forecasts.",
    loadedWithWarnings: "Updated {stamp} · {loadedCount}/{count} companies · {warningCount} with missing data.",
...
const COMPANIES = [
  { id: "nvidia", name: "英伟达", ticker: "NVDA", color: "#9be000", logoColor: "#76b900", optionLogoFit: "wide-symbol", logoPath: "assets/logos/nvidia.svg?v=20260629-visible-area-v4" },
  { id: "alphabet", name: "谷歌", ticker: "GOOGL", color: "#008894", deepColor: "#00d4e8", logoColor: "#4285f4", optionLogoFit: "symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, logoPath: "assets/logos/alphabet.svg?v=20260717-brand-colors-v5" },
  { id: "apple", name: "苹果", ticker: "AAPL", color: "#4b5563", deepColor: "#7b8490", logoColor: "#000000", optionLogoFit: "symbol", logoPath: "assets/logos/apple.svg?v=20260629-visible-area-v4" },
  { id: "microsoft", name: "微软", ticker: "MSFT", color: "#0047ab", deepColor: "#2563eb", logoColor: "#737373", optionLogoFit: "symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, optionLogoPath: "assets/logos/options/microsoft.svg?v=20260830-compact-marks", logoPath: "assets/logos/microsoft.svg?v=20260629-visible-area-v4" },
  { id: "amazon", name: "亚马逊", ticker: "AMZN", color: "#a86400", deepColor: "#ff9900", logoColor: "#ff9900", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/amazon.svg?v=20260830-compact-marks", preserveLightLogoColors: true, logoPath: "assets/logos/amazon.svg?v=20260629-visible-area-v4" },
  { id: "avgo", name: "博通", ticker: "AVGO", color: "#b8a1ff", logoColor: "#cc092f", optionLogoFit: "symbol", logoPath: "assets/logos/avgo.svg?v=20260629-visible-area-v4" },
  { id: "meta", name: "Meta", ticker: "META", color: "#a21caf", deepColor: "#d946ef", logoColor: "#0866ff", optionLogoFit: "wide-symbol", logoPath: "assets/logos/meta.svg?v=20260629-visible-area-v4" },
  ...
  { id: "tsla", name: "特斯拉", ticker: "TSLA", color: "#700020", deepColor: "#bd0026", logoColor: "#e82127", optionLogoFit: "symbol", logoPath: "assets/logos/tsla.svg?v=20260629-visible-area-v4" },
  { id: "walmart", name: "沃尔玛", ticker: "WMT", color: "#86d63b", logoColor: "#0071ce", optionLogoColor: "#ffc220", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/walmart.svg?v=20260830-compact-marks", preserveLightLogoColors: true, logoPath: "assets/logos/walmart.svg?v=20260717-brand-colors-v5" },
  ...
  { id: "jpmorgan", name: "摩根大通", ticker: "JPM", color: "#2aa6a4", logoColor: "#005eb8", optionLogoColor: "#117aca", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/chase.svg?v=20260830-compact-marks", logoPath: "assets/logos/jpmorgan.svg?v=20260629-visible-area-v4" },
  ...
  { id: "micron", name: "美光", ticker: "MU", color: "#8b7dff", logoColor: "#0057b8", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/micron.svg?v=20260830-compact-marks", logoPath: "assets/logos/micron.svg?v=20260629-visible-area-v4" },
  { id: "jnj", name: "强生", ticker: "JNJ", color: "#ff4d6d", logoColor: "#d71920", logoPath: "assets/logos/jnj.svg?v=20260629-visible-area-v4" },
  { id: "oracle", name: "甲骨文", ticker: "ORCL", color: "#f45d48", logoColor: "#f80000", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/oracle.svg?v=20260830-compact-marks", logoPath: "assets/logos/oracle.svg?v=20260629-visible-area-v4" },
  { id: "amd", name: "AMD", ticker: "AMD", color: "#66d17a", logoColor: "#000000", optionLogoDeepColor: "#f5f7fa", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/amd.svg?v=20260830-compact-marks", logoPath: "assets/logos/amd.svg?v=20260629-visible-area-v4" },
  { id: "mastercard", name: "万事达", ticker: "MA", color: "#ff9d57", logoColor: "#eb001b", optionLogoFit: "wide-symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, logoPath: "assets/logos/mastercard.svg?v=20260717-brand-colors-v5" },
  ...
  { id: "netflix", name: "奈飞", ticker: "NFLX", color: "#e50914", logoColor: "#e50914", optionLogoFit: "symbol", logoPath: "assets/logos/netflix.svg?v=20260629-visible-area-v4" },
  { id: "bankofamerica", name: "美国银行", ticker: "BAC", color: "#7aa6ff", logoColor: "#e31837", optionLogoFit: "wide-symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, logoPath: "assets/logos/bankofamerica.svg?v=20260717-brand-colors-v5" },
  ...
  { id: "chevron", name: "雪佛龙", ticker: "CVX", color: "#5fb3d9", logoColor: "#0054a6", optionLogoFit: "wide-symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, logoPath: "assets/logos/chevron.svg?v=20260717-brand-colors-v5" },
  { id: "palantir", name: "Palantir", ticker: "PLTR", color: "#b877ff", logoColor: "#101820", optionLogoFit: "symbol", logoPath: "assets/logos/palantir.svg?v=20260629-visible-area-v4" },
  { id: "cisco", name: "思科", ticker: "CSCO", color: "#4fb6c2", logoColor: "#1ba0d7", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/cisco.svg?v=20260830-compact-marks", logoPath: "assets/logos/cisco.svg?v=20260629-visible-area-v4" },
  { id: "abbvie", name: "艾伯维", ticker: "ABBV", color: "#7f78d2", logoColor: "#071d49", logoPath: "assets/logos/abbvie.svg?v=20260629-visible-area-v4" },
  { id: "homedepot", name: "家得宝", ticker: "HD", color: "#f97316", logoColor: "#f96302", optionLogoFit: "symbol", logoPath: "assets/logos/homedepot.svg?v=20260629-visible-area-v4" },
  ...
  { id: "crowdstrike", name: "CrowdStrike", ticker: "CRWD", color: "#ff5a67", logoColor: "#fc0000", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/crowdstrike.svg?v=20260830-compact-marks", logoPath: "assets/logos/crowdstrike.svg?v=20260629-visible-area-v4" },
  { id: "salesforce", name: "Salesforce", ticker: "CRM", color: "#1fb6ff", logoColor: "#00a1e0", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/salesforce.svg?v=20260830-compact-marks", logoPath: "assets/logos/salesforce.svg?v=20260629-visible-area-v4" },
  { id: "servicenow", name: "ServiceNow", ticker: "NOW", color: "#7ee787", logoColor: "#3a7d44", optionLogoColor: "#62d84e", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/servicenow.svg?v=20260830-compact-marks", logoPath: "assets/logos/servicenow.svg?v=20260629-visible-area-v4" },
  { id: "datadog", name: "Datadog", ticker: "DDOG", color: "#9b87f5", logoColor: "#632ca6", optionLogoFit: "symbol", logoPath: "assets/logos/datadog.svg?v=20260629-visible-area-v4" },
  { id: "snowflake", name: "Snowflake", ticker: "SNOW", color: "#29b5e8", logoColor: "#29b5e8", optionLogoFit: "symbol", logoPath: "assets/logos/snowflake.svg?v=20260629-visible-area-v4" },
  { id: "cloudflare", name: "Cloudflare", ticker: "NET", color: "#f48120", logoColor: "#f48120", optionLogoFit: "wide-symbol", preserveLightLogoColors: true, preserveOptionLogoColors: true, logoPath: "assets/logos/cloudflare.svg?v=20260717-brand-colors-v5" },
  { id: "adobe", name: "Adobe", ticker: "ADBE", color: "#ff3366", logoColor: "#eb1000", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/adobe.svg?v=20260830-compact-marks", preserveLightLogoColors: true, logoPath: "assets/logos/adobe.svg?v=20260629-visible-area-v4" },
  { id: "zoom", name: "Zoom", ticker: "ZM", color: "#6b8cff", logoColor: "#2d8cff", optionLogoFit: "wide-symbol", optionLogoPath: "assets/logos/options/zoom.svg?v=20260830-compact-marks", logoPath: "assets/logos/zoom.svg?v=20260629-visible-area-v4" },
  { id: "coreweave", name: "CoreWeave", ticker: "CRWV", color: "#01d1ff", logoColor: "#000000", optionLogoDeepColor: "#f5f7fa", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/coreweave.svg?v=20260830-compact-marks", logoPath: "assets/logos/coreweave.svg?v=20260629-visible-area-v4" },
  { id: "nebius", name: "Nebius", ticker: "NBIS", color: "#b9ff38", logoColor: "#000000", optionLogoColor: "#b9ff38", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/nebius.svg?v=20260830-compact-marks", logoPath: "assets/logos/nebius.svg?v=20260629-visible-area-v4" },
  { id: "chronoscale", name: "ChronoScale", ticker: "CHRN", color: "#768cff", logoColor: "#4f46e5", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/chronoscale.svg?v=20260830-compact-marks", logoPath: "assets/logos/chronoscale.svg?v=20260629-visible-area-v4" },
  { id: "sharonai", name: "SharonAI", ticker: "SHAZ", color: "#ffbd3f", logoColor: "#d97706", optionLogoFit: "symbol", optionLogoPath: "assets/logos/options/sharonai.svg?v=20260830-compact-marks", logoPath: "assets/logos/sharonai.svg?v=20260629-visible-area-v4" },
];
...
function createToggle(company) {
  ...
  if (company.optionLogoFit === "symbol" || company.optionLogoFit === "wide-symbol") {
    logo.classList.add(`company-option-logo--${company.optionLogoFit}`);
  }
